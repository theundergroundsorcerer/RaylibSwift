...
public enum ScreenSpace {
    ...
    @inlinable
    public static func getScreenToWorldRay(_ position: Vector2, _ camera: Camera) -> Ray {
    ...
    public static func getScreenToWorldRayEx(
        _ position: Vector2, _ camera: Camera, _ width: Int32, _ height: Int32
    ) -> Ray {
    ...
    @inlinable
    public static func getMouseRay(_ position: Vector2, _ camera: Camera) -> Ray {
